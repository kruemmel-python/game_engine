import * as THREE from 'three'; import * as CANNON from 'cannon-es'; import type { Game } from '../core/Game'; import type { GameObject } from '../ecs/GameObject'; import { Component } from '../ecs/Component';
export class CameraFollow extends Component {
  ...
  onAdded(game: Game, owner: GameObject){ super.onAdded(game, owner); this.game.controls.enabled=false; const el=this.game.renderer.domElement; el.addEventListener('mousedown', this.onDown); addEventListener('mouseup', this.onUp); addEventListener('mousemove', this.onMove); el.addEventListener('contextmenu', this.onCtx); }
